<template lang="pug">
.rq-status(
  :class="classStatusObj(status)"
)
  .rq-status__wrapper
    .rq-status__inner( v-if="!status" )
      .rq-status__title {{ 'открыт набор' }}
    .rq-status__inner( v-else )
      .rq-status__icon( v-if="status === 'invited'" )
